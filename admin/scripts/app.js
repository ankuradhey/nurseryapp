...
//              'scripts/services/schoolService.js',
            ...
            resolve: {
                ...
                .state('dashboard.addreview', {
            url: '/addreview',
            access: access.admin,
            data: {collapseVar: 'parent'},
            controller: 'reviewAddController',
            templateUrl: 'views/reviews/addreview.html',
            resolve: {
                auth: function($q, authService) {
                    var userInfo = authService.getUserInfo();
                    if (userInfo && authService.authorize(access.admin)) {
                ...
                parents: function(schoolService) {
                    return schoolService.getParents();
                }
            }
        })
            ...
            resolve: {
                ...
                .state('dashboard.fullpagebanner', {
            url: '/fullpagebanner',
            access: access.admin,
            data: {collapseVar: 'school'},
            controller: 'advertisementController',
            templateUrl: 'views/advertisements/addfullpagebanner.html',
            resolve: {
                auth: function($q, authService) {
                    var userInfo = authService.getUserInfo();
                    if (userInfo && authService.authorize(access.school)) {
