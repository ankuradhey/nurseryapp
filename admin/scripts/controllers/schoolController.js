...
//                                $scope.school.facility = 
                ...
                $scope.saveFacility = function () {
                    console.log(facilities.data.facilities, $scope.school.newfacility);
                    if (!$scope.school.newfacility) {
                        alert('Please enter facility');
                    } else {
                        facilities.data.facilities.forEach(function (curr, index) {
//                    console.log(curr.facility_name.toLowerCase(), $scope.school.newfacility.trim(), (curr.facility_name.toLowerCase() == $scope.school.newfacility.trim()));
                            if (curr.facility_name.toLowerCase() == $scope.school.newfacility.trim().toLowerCase()) {
                                alert('Please enter new facility');
                                return;
                            }
                        });
